...
# Top‑level output folder (segment & app will be added later)
...
# Temporary logger using generic path; real path is set in main()
...
class NewRelicLookup:
    def __init__(self) -> None:
        ...
        if not self.nr_api_key:
            logger.log("WARNING: NR_API_KEY not set. NR lookups will fail.", "WARNING")
